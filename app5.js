...
// - Dashboard table: ONLY Breakout + category dropdown filter
...
// -------- DASHBOARD (TABLE = BREAKOUT ONLY + CATEGORY FILTER) --------
function renderDashboard(allRows) {
    ...
    statusEl.textContent =
        `Table category: ${catLabel}. Breakout rows: ${breakoutRows.length}. Showing: ${visible.length} (max ${DASHBOARD_MAX_ROWS}).`;
}
...
// NEW: Dashboard category filter event
